...
const CourseCard = (props) => {
    const {title, instructor, price, image } = props.course
    return (
                ...
                <div>
                    <div className="card card-bg mb-3 shadow" >
                        ...
                        <div className="card-body">
                            ...
                            <button onClick={()=>props.manageCart(props.course)} className='btn btn-success rounded d-block mx-auto mt-4'><FontAwesomeIcon icon={faSmile}/> Enroll Course</button>
                        </div>
                    </div>           
                </div>
            </div>
